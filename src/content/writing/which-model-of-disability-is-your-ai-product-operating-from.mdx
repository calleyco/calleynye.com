...
My presentation at McKinsey ended with an illustration that I think about constantly: three panels showing the difference between equality, accommodations, and inclusivity. In the equality frame, everyone gets the same box to stand on. In accommodations, different people get different-sized boxes. In inclusivity, the ground itself is redesigned so no one needs a box at all.
...
<aside className="essay-callout essay-callout--social">
